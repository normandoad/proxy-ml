...
public class RequestHandler implements Runnable {
	...
	private HashMap<String, String> whiteSites = new HashMap<String, String>();
	...
	public RequestHandler(Socket clientSocket) {
		whiteSites.put("http://api.mercadolibre.com:443", "http://api.mercadolibre.com:443");
		whiteSites.put("http://app.fakejson.com:443", "http://app.fakejson.com:443");
		whiteSites.put("http://app.fakejson.com/q", "http://app.fakejson.com/q");
	...
	public void run() {
		...
		try {
			...
			// Check if site is permitted site

			if (this.whiteSites.get(urlString) != null) {
				// Check request type
				if (request.equals("CONNECT")) {
					log.info("HTTPS Request for : " + urlString + "\n");
	...
	private void handleHTTPSRequest(String urlString) {
		...
		BufferedWriter proxyToServerBW = null;
		...
		try {
			...
			try {
				...
				log.error("Error on closing Sockets : " + urlString);
				log.error(e);
			}
		}
	}
